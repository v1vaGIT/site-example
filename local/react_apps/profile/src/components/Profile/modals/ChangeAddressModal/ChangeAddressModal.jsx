...
const ChangeAddressModal = ({ addressValues, closeModal, changeAddress }) => {
    ...
    const { handleSubmit, control, formState: { errors, isValid } } = useForm({ defaultValues: addressValues })

    return (
        <div className={s.modalWrapper}>
            <form ref={modalRef} className={s.modal} onSubmit={handleSubmit(changeAddress)}>
